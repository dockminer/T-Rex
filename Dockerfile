...
RUN wget https://github.com/trexminer/T-Rex/releases/download/0.19.10/t-rex-0.19.10-linux-cuda10.0.tar.gz && \
    tar xf t-rex-0.19.10-linux-cuda10.0.tar.gz -C t-rex
